...
export default function Home() {
  return (
    <>
      {/*
       * ── Background layers ─────────────────────────────────────────
       * 1. Soft center radial glow (the light cast upward from the arc)
       * 2. The earth arc itself — positioned by .earth-arc CSS class
       */}
      <div
        ...
        aria-hidden="true"
      />
      <div className="earth-arc" aria-hidden="true" />

      {/* ── Page content ────────────────────────────────────────────── */}
      <main className="relative z-10 min-h-dvh flex flex-col items-center justify-center px-5 pt-8 pb-[42vh] gap-8">

        {/* Hero — Bolt-style large centered headline */}
        <header className="flex flex-col items-center gap-4 text-center max-w-[680px]">
        ...
        {/* Import-style hint row — inspired by Bolt's "or import from" */}
